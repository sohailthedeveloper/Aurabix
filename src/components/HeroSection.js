...
export default function HeroSection() {
  ...
  return (
    <section ref={containerRef} className="relative flex flex-col items-center justify-center min-h-[100dvh] py-16 md:py-24 overflow-hidden px-4 md:px-6 bg-[#000000]">
      ...
      >
        ...
        <motion.h1
          ...
          className="font-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-6 md:mb-8 leading-[1.1] drop-shadow-2xl px-2"
        >
          AI-Powered <br />
