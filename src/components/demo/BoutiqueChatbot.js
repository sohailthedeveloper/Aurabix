...
export default function BoutiqueChatbot({ phone, onBook }) {
  ...
  const waMessage = encodeURIComponent("Hello, I'd like to enquire about booking a consultation at Elite London Dental.");
        ...
        {isOpen && (
          ...
          >
            ...
            <div className="p-6 min-h-[160px] flex flex-col justify-end">
              ...
              >
                <p className="mb-3">Welcome to Elite London Dental. 👋</p>
